export function HeroBlock({ props }: { props: any }) {
  return (
    <div className="relative flex items-center justify-center" style={{ minHeight: props.minHeight || "400px", backgroundImage: props.backgroundImage ? `url(${props.backgroundImage})` : undefined, backgroundSize: "cover", backgroundPosition: "center" }}>
